...
\toprule
\textbf{System} & \textbf{Grounding} & \textbf{Architecture} & \textbf{Learning} & \textbf{Apps} & \textbf{Open} & \textbf{OSWorld\textsuperscript{*}} \\
\midrule
AgenticOS v2 (ours) & UIA+VLM+OCR & Modular ReAct & Q-learn+Human & 15+ & \checkmark & --- \\
...
\bottomrule
\end{tabular}
\caption{Comparison of desktop automation systems. AgenticOS is the only system with online RL and human supervision. \textsuperscript{*}OSWorld results are on Ubuntu. ``---'' indicates not reported or not applicable.}
